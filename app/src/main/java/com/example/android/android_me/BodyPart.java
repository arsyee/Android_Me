 ...
 * {@link BodyPart.OnFragmentInteractionListener} interface
...
public class BodyPart extends Fragment {
     ...
     * @return A new instance of fragment BodyPart.
     */
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        ImageView ivBodyPart = (ImageView) root.findViewById(R.id.iv_body_part);
        ivBodyPart.setImageResource(AndroidImageAssets.getHeads().get(0));
        return root;
    }
